...
<div id="DNN6" class="Home">
    ...
    <div id="Header">
        <div id="ContentBG">
		    ...
		    <div class="Content">
                <div id="Nav">         
                    <a href="/">
                        <img src="/Portals/0/LogoSmall.png" alt="Badges for Bullies" style="float:left;height:50px;padding:-1px 10px 20px 10px;margin-left:-80px;"" />           
                    </a>
    ...
    <div id="Content">
        <div id="Panes">
		    <div id="LogoRow" runat="server" visible="false">
